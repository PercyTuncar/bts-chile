...
export default async function EntradasPage() {
  ...
  const jsonLd = buildGraph([
    ...
    buildWebsite(),
    {
      ...
      about: { "@id": `${SITE_URL}/entradas#event-oct-17` },
      mainEntity: { "@id": `${SITE_URL}/entradas#event-oct-17` },
    ...
    {
      "@type": "MusicGroup",
      "@id": `${SITE_URL}/entradas#performer-bts`,
      name: "BTS",
    ...
    // Main Event - 17 October (only available date)
    {
      "@type": "MusicEvent",
      "@id": `${SITE_URL}/entradas#event-oct-17`,
      name: 'BTS WORLD TOUR "ARIRANG" IN SANTIAGO',
      alternateName: "BTS Chile 2026",
      description:
        "BTS presenta su esperado concierto en Chile como parte del BTS WORLD TOUR ARIRANG 2026. Única fecha disponible: 17 de octubre de 2026 en el Estadio Nacional de Santiago.",
      image: [
      ...
      location: { "@id": `${SITE_URL}/entradas#venue` },
      performer: { "@id": `${SITE_URL}/entradas#performer-bts` },
      ...
      inLanguage: ["ko", "en"],
      maximumAttendeeCapacity: 47000,
      offers: zones.filter(z => z.stock > 0).map((zone) => ({
        "@type": "Offer",
        "@id": `${SITE_URL}/entradas#offer-${zone.zoneId}`,
        name: `Entrada ${zone.zoneName}`,
        description: zone.description,
        price: zone.priceUSD,
        priceCurrency: "USD",
        availability: zone.stock > 0 && zone.stock <= 5 ? "https://schema.org/LimitedAvailability" : zone.stock > 0 ? "https://schema.org/InStock" : "https://schema.org/SoldOut",
        validFrom: DATE_PUBLISHED,
        url: `${SITE_URL}/entradas#zona-${zone.zoneNumber}`,
    ...
    {
      "@type": "MusicEvent",
      "@id": `${SITE_URL}/entradas#event-oct-14`,
      name: 'BTS WORLD TOUR "ARIRANG" IN SANTIAGO - 14 de octubre',
      startDate: "2026-10-14T20:00:00-03:00",
      endDate: "2026-10-14T23:00:00-03:00",
    ...
    {
      "@type": "MusicEvent",
      "@id": `${SITE_URL}/entradas#event-oct-16`,
      name: 'BTS WORLD TOUR "ARIRANG" IN SANTIAGO - 16 de octubre',
      startDate: "2026-10-16T20:00:00-03:00",
      endDate: "2026-10-16T23:00:00-03:00",
      eventStatus: "https://schema.org/EventSoldOut",
      eventAttendanceMode: "https://schema.org/OfflineEventAttendanceMode",
      location: { "@id": `${SITE_URL}/entradas#venue` },
      performer: { "@id": `${SITE_URL}/entradas#performer-bts` },
